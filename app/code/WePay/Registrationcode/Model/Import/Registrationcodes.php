<?php
namespace WePay\Registrationcode\Model\Import;
 ...
 * Class Courses
 */
class Registrationcodes extends AbstractEntity
{
    const ENTITY_CODE = 'registration_codes';
    const TABLE = 'registration_code';
    ...
    public function validateRow(array $rowData, $rowNum): bool
    {
        ...
        $code = $rowData['code'] ?? '';
        $reusable = (int) $rowData['reusable'] ?? 0;
        $case_sensitive = (int) $rowData['case_sensitive'] ?? 0;
        $customer_group = (int) $rowData['customer_group'] ?? 1;
        $count = (int) $rowData['count'] ?? 0;
        $active = (int) $rowData['active'] ?? 1;
