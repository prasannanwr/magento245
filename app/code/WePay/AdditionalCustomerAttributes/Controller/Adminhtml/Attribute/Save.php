 ...
 */
class Save extends \WePay\AdditionalCustomerAttributes\Controller\Adminhtml\Attribute
{
    /**
    ...
    public function __construct(
        ...
        \WePay\AdditionalCustomerAttributes\Model\ResourceModel\Eav\AttributeFactory $attributeFactory,
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            if (isset($data['wepay_dvalue']) && is_array($data['wepay_dvalue'])) {
                $data['wepay_dvalue']  = implode(",", $data['wepay_dvalue']);
                if ($data['wepay_dvalue'] == "") {
                    $data['wepay_dependable']  = 0;
                    $data['wepay_dpath']  = '\\';
                    $data['wepay_dcode']  = '';
                    $data['wepay_did']  = 0;
                }
            }
            if($data['wepay_dependable'] == 0) {
                $data['wepay_dvalue'] = "";
                $data['wepay_dpath']  = '\\';
                $data['wepay_dcode']  = '';
                $data['wepay_did']  = 0;
    ...
    {
        return $this->_authorization->isAllowed('WePay_AdditionalCustomerAttributes::attributes_save');
    }
}
