...
class Date extends \WePay\AdditionalCustomerAttributes\Block\Element\AbstractRenderer
{
    /**
    ...
    public function __construct(
        ...
        \WePay\AdditionalCustomerAttributes\Block\Element\Framework\Date $dateElement,
        array $data = []
    ) {
     ...
     * @return string
     */
    public function getDateElementHtml($form = null)
    {
        $this->dateElement->setData([
            'name' => $this->getAttributeName(),
            'id' => $this->getAttributeId(),
            'class' => $this->getValidateClasses(),
            'value' => $this->getValue(),
            'disabled' => !$this->getIsEditable(),
            'date_format' => $this->getDateFormat(),
            'data_form_part' => $form,
            'image' => $this->getViewFileUrl('Magento_Theme::calendar.png'),
            'extra_params' => '
                acode = "'.$this->getCurrentAttribute()->getAttributeCode().'" 
                dependable = "'.$this->getCurrentAttribute()->getWepayDependable().'" 
                dcode = "'.$this->getCurrentAttribute()->getWepayDcode().'" 
                did = "'.$this->getCurrentAttribute()->getWepayDid().'" 
                dvalue = "'.$this->getCurrentAttribute()->getWepayDvalue().'"',
        ]);
    ...
    public function getTimestamp()
    {
        ...
        $attributeCodeObj = $this->getCurrentAttribute()->getAttributeCode();
