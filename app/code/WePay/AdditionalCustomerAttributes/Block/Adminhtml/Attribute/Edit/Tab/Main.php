...
class Main extends AbstractMain
{
    ...
    protected function _prepareForm()
    {
        ...
        $this->_eventManager->dispatch(
            'adminhtml_additionalcustomerattributes_attribute_types',
            ['response' => $response]
        );
        $_hiddenFields = [];
        ...
        $this->_eventManager->dispatch(
            'additionalcustomerattributes_form_build_main_tab',
            ['form' => $form]
        );
    ...
    {
        return ['apply' => 'WePay\AdditionalCustomerAttributes\Block\Adminhtml\Helper\Form\Apply'];
    }
}
