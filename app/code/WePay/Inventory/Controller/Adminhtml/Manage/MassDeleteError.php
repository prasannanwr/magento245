...
use WePay\Inventory\Model\ResourceModel\ErrorLogs\CollectionFactory;

class MassDeleteError extends Action
{
    /**
    ...
    public function execute()
    {
        ...
        return $this->resultFactory->create(ResultFactory::TYPE_REDIRECT)->setPath('wepay_inventory/errorlogs/index');
    }
