 ...
 */
namespace FME\AdditionalCustomerAttributes\Block\Adminhtml\Customer\Edit;
...
class Tabs extends Generic implements TabInterface
{
    ...
    public function getFormHtml()
    {
        ...
        $html .= $this->getLayout()->createBlock(
            'FME\AdditionalCustomerAttributes\Block\Adminhtml\Customer\Edit\Tab\Attributes'
        )->setTemplate('FME_AdditionalCustomerAttributes::accountAttributes.phtml')->toHtml();
        return $html;
    }
}
