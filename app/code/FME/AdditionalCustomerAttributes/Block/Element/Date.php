...
class Date extends \FME\AdditionalCustomerAttributes\Block\Element\AbstractRenderer
{
    /**
    ...
    public function __construct(
        ...
        \FME\AdditionalCustomerAttributes\Block\Element\Framework\Date $dateElement,
        array $data = []
    ) {
    ...
    public function getDateElementHtml($form = null)
    {
        $this->dateElement->setData([
            ...
            'extra_params' => '
                ...
                dependable = "'.$this->getCurrentAttribute()->getFmeDependable().'" 
                dcode = "'.$this->getCurrentAttribute()->getFmeDcode().'" 
                did = "'.$this->getCurrentAttribute()->getFmeDid().'" 
                dvalue = "'.$this->getCurrentAttribute()->getFmeDvalue().'"',
        ]);
