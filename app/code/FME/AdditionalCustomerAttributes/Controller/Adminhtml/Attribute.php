 ...
 */
namespace FME\AdditionalCustomerAttributes\Controller\Adminhtml;
...
abstract class Attribute extends \Magento\Backend\App\Action
{
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'FME_AdditionalCustomerAttributes::attributes_attributes';
    ...
    public function createActionPage($title = null)
    {
        ...
        $resultPage->addBreadcrumb(__('FME'), __('FME'))
            ...
            ->setActiveMenu('FME_AdditionalCustomerAttributes::attributes');
        if (!empty($title)) {
