...
class Edit extends \FME\AdditionalCustomerAttributes\Controller\Adminhtml\Attribute
{
    /**
    ...
    {
        return $this->_authorization->isAllowed('FME_AdditionalCustomerAttributes::attributes_edit');
    }
}
