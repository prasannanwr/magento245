 ...
 */
namespace FME\AdditionalCustomerAttributes\Model\ResourceModel\Attribute;
...
class Collection extends \Magento\Catalog\Model\ResourceModel\Product\Attribute\Collection
{
    ...
    public function _initSelect()
    {
        ...
        // ->joinLeft(
        //     ['additionalcustomerattributes_table' => $this->getTable('fme_additionalcustomerattributes')],
        //     'additionalcustomerattributes_table.attribute_id = main_table.attribute_id',
        //     ['customer_value'=>'value']
        // )
        ->join(
            ['store_table' => $this->getTable('fme_additionalcustomerattributes_stores')],
            ...
            ['group_table' => $this->getTable('fme_additionalcustomerattributes_customer_group')],
    ...
    {
        return $this->addFieldToFilter('main_table.fme_email', 1);
    }
